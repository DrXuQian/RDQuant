...
\end{tabular}
\end{table}
The measured 2.59$\times$ decode speedup is close to the theoretical 2.8$\times$ from the bandwidth model, indicating that the Marlin kernels achieve near-peak memory throughput.
